						...
						<div class="row">
							<div class="col-lg-10">
								<s:form action="saveupdatestaff" id="updateStaff"
									...
									<div class="form-group">
										<label class="control-label col-sm-4" for="placeOfBirth">Place
											Of Birth:</label>
										<div class="col-sm-6">
											<input type="text" class="form-control" id="placeOfBirth"
												maxlength="50" name="placeOfBirth" value="${placeOfBirth }"
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<s:select class="form-control" id="role" list="%{listRole}"
												theme="simple" listKey="%{id}" style="width:100%"
												listValue="%{roleName}" value="%{id}" name="role.id" />
										</div>
									...
									<div class="form-group">
										<label class="control-label col-sm-4" for="fatherPlaceOfWork">Father
											Place Of Work:</label>
										<div class="col-sm-6">
											<input type="text" class="form-control"
												value="${fatherPlaceOfWork }" id="fatherPlaceOfWork"
												name="fatherPlaceOfWork" placeholder="Enter fatherPlaceOfWork">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-4" for="motherPlaceOfWork">Mother
											Place Of Work:</label>
										<div class="col-sm-6">
											<input type="text" class="form-control"
												value="${motherPlaceOfWork }" id="motherPlaceOfWork"
												name="motherPlaceOfWork" placeholder="Enter motherPlaceOfWork">
										</div>
									</div>
