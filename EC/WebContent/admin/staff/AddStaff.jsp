			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-10">
								<s:form action="saveaddstaff"
									cssClass="form-horizontal col-xs-12" id="formStaff"
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control" id="placeOfBirth"
												maxlength="50" name="placeOfBirth"
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control"
												id="fatherPlaceOfWork" maxlength="50"
												name="fatherPlaceOfWork" placeholder="Enter fatherOfWork">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" class="form-control"
												id="motherPlaceOfWork" maxlength="50"
												name="motherPlaceOfWork" placeholder="Enter motherOfWork">
										</div>
									</div>
