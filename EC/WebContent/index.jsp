				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="#"><i class="fa fa-sitemap fa-fw"></i>Claims<span
						...
						<ul class="nav nav-second-level">
							<li><a href="getAllClaims">Claims List</a></li>



						</ul></li>
					<li><a href="#"><i class="fa fa-sitemap fa-fw"></i>Claims
							Type<span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="getAllType">Claims Type List</a></li>
							<li><a href="addType">Add Claim Type</a></li>
					...
					<li><a href="#"><i class="fa fa-sitemap fa-fw"></i>Student<span
							class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a href="getAllStudent">Student List</a></li>
